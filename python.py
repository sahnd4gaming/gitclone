...
def login():
	...
	try:
		...
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mAccount is checkpoint")
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91mHAMA-WOLF\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;91mHAMA WOLF\033[1;95m◈•══════•◈•"
		try:
	...
	print "   \033[1;92m◄══════════════════H A M A══════════════════►"

	jalan('          \033[1;91mStarted Cloning Please Wait 20minute...')
	print  "  \033[1;92m ◄══════════════════W O L F══════════════════►" 
	...
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬•◈\033[1;91mHAMA-WOLF\033[1;95m◈•▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By HAMA-WOLF--•◈•---»"
